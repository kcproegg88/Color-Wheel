...
class colored_shape:
    ...
    def color_change(self):
        ...
        r = max(min(int(math.cos(self.angle * f)*self.range + self.base + self.range/2), self.peak), self.base)
        g = max(min(int(math.cos(self.angle*f-math.pi*2/3)*self.range + self.base+self.range/2), self.peak), self.base)
        b = max(min(int(math.cos(self.angle*f+math.pi*2/3)*self.range + self.base+self.range/2), self.peak), self.base)
